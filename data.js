...
window.ITINERARY = {
  ...
  days: [
    ...
    {
      n: 2, dow: "Mié", date: "13 may", neighborhood: "Anguk · Jongno",
      title: "Palacios, Bukchon e Ikseon-dong",
      summary: "El día clásico imprescindible. Cambio de guardia en el palacio principal, samgyetang icónico para almorzar, hanok village con truco anti-cuesta, paseo por Insadong y cena en los hanoks reconvertidos de Ikseon-dong.",
      walked: "~9-11 km",
      schedule: [
        ...
        { time: "18:00", act: "Ikseon-dong (10 min andando)", area: "Ikseon-dong", cost: "Cafetería ~5 €", note: "Hanoks reconvertidos: cafés y boutiques" },
        { time: "19:30", act: "Cena: Ikseon Aetteut o GUO", area: "Ikseon-dong", cost: "25-30 €/p", note: "Reservamos Catch Table 2-3 días antes" },
        { time: "21:00", act: "Metro a Express Bus Terminal (L3) + paseo a Banpo", area: "→ Banpo", cost: "1.500 KRW", note: "Salida 8-1, 15 min andando al césped sur" },
        { time: "21:30", act: "🌈 Banpo Bridge Rainbow Fountain (último pase)", area: "Banpo", cost: "Gratis", note: "Show de 20 min. Llevamos algo para sentarnos" },
      ...
      stops: [
        ...
        },
        {
          ...
          desc: "El barrio joya. Hanoks de los años 30 reconvertidos en cafeterías, restaurantes y boutiques de diseño. Más auténtico que Bukchon de noche, ambiente menos turístico y más coreano joven. Aquí cenáis.",
      ...
      meals: [
        ...
        { type: "Cena principal", name: "Ikseon Aetteut", kr: "익선애뜻", price: "~25 €/p", note: "Cerdo a la parrilla con arroz, fusión moderna. Reservamos Catch Table 2-3 días antes." },
      ...
      tips: [
        ...
        { icon: "💡", text: "Después de cenar: cafetería en Ikseon-dong (Madang Flower Café tiene patio precioso) o paseo por callejones iluminados antes del metro." },
        { icon: "🚻", text: "Baños limpios: dentro del palacio, oficina de turismo de Insadong y Ssamzigil." }
      ],
          gallery: ["https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Korean_cuisine-Samgyetang-01.jpg/800px-Korean_cuisine-Samgyetang-01.jpg","https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Samgyetang_2.jpg/800px-Samgyetang_2.jpg","https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Korean.cuisine-Samgyetang-04.jpg/800px-Korean.cuisine-Samgyetang-04.jpg"]
    },
{
