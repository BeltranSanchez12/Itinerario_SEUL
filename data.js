...
{
  n: 3, dow: "Jue", date: "14 may", neighborhood: "Seoul Forest · Gangnam · Centro · Ikseon-dong",
  title: "Parque, biblioteca, canal, mercado y hanoks",
  summary: "Arrancamos suaves en Seoul Forest (paseo + jardín de ciervos, 1 h), bajamos a Gangnam para la biblioteca Starfield y foto de Gangnam Style, almuerzo de gomtang histórico (Bib Gourmand desde 1939), paseo por el canal Cheonggyecheon, snacks callejeros en Gwangjang, arquitectura de Zaha Hadid en DDP al anochecer y cierre con cena en los hanoks reconvertidos de Ikseon-dong.",
  walked: "~10-11 km (todo plano)",
  schedule: [
    { time: "09:00", act: "Desayuno rápido en Hongdae", area: "Hongdae", cost: "8 €/p", note: "Pancake Originals (suflé) o café local. Salir más temprano que otros días" },
    { time: "09:30", act: "Metro Hongik Univ (L2) → Ttukseom (L2) directo", area: "→ Seoul Forest", cost: "1.500 KRW", note: "6 paradas, ~25 min. Sin transbordos" },
    { time: "10:00", act: "Salida 8 Ttukseom → Seoul Forest (3 min)", area: "Seoul Forest", cost: "—", note: "Plano" },
    { time: "10:05", act: "⭐ Seoul Forest — paseo + jardín de ciervos", area: "Seoul Forest", cost: "Gratis", note: "<strong>Modo express: 50 min</strong>. Entrada principal → deer park → vuelta. Sin más rodeos" },
    { time: "11:00", act: "Walk 3 min a Ttukseom station", area: "→ Gangnam", cost: "—", note: "" },
    { time: "11:05", act: "Metro Ttukseom (L2) → Samseong (L2) directo", area: "→ Gangnam", cost: "1.500 KRW", note: "5 paradas, ~12 min. Sin transbordos" },
    { time: "11:30", act: "Starfield Library + COEX (paseo + foto)", area: "Gangnam", cost: "Gratis", note: "Biblioteca de 13 m, Kakao Friends, Aland. 45 min" },
    { time: "12:15", act: "Estatua Gangnam Style (foto rápida)", area: "Gangnam", cost: "Gratis", note: "5 min, salida 5 de Samseong" },
    { time: "12:25", act: "Metro Samseong (L2) → Euljiro 1-ga (L2)", area: "→ Myeongdong", cost: "1.500 KRW", note: "Directo, ~25 min" },
    { time: "13:00", act: "⭐ Almuerzo: Hadongkwan (gomtang Bib Gourmand)", area: "Myeongdong", cost: "~12 €/p", note: "Desde 1939. Walk-in only. Sirven en 2 min. <strong>Llegar antes de 14:00 — cierra a las 16:00</strong>" },
    { time: "14:00", act: "Andar 10 min al norte → Cheonggye Plaza", area: "Centro", cost: "—", note: "Plano. Escultura 'Spring'" },
    { time: "14:30", act: "Paseo canal Cheonggyecheon (1,5 km al este)", area: "Centro", cost: "Gratis", note: "Bajar al nivel del agua. Si veis cansancio, salimos antes y taxi" },
    { time: "15:45", act: "⭐ Snacks callejeros en Gwangjang Market", area: "Jongno", cost: "8-12 €/p", note: "Bindaetteok, mayak gimbap, tteokbokki. Ligero — cena es en Ikseon" },
    { time: "16:45", act: "Andar 5 min a Ikseon-dong", area: "Ikseon-dong", cost: "—", note: "Paseo por los callejones de hanoks" },
    { time: "17:00", act: "Café en Ikseon-dong (Madang Flower Café u Onion)", area: "Ikseon-dong", cost: "~5 €/p", note: "Patio precioso, ideal para descansar" },
  ...
  stops: [
    {
      name: "Seoul Forest (express)", kr: "서울숲",
      desc: "Parada de 50 min para arrancar el día con verde antes del cemento de Gangnam. Salida 8 de Ttukseom, 3 min al parque. Vamos directos al <strong>jardín de ciervos sika</strong> (foto), un rato de paseo por el sendero central, y vuelta. Sin rodear el lago ni meternos en zonas alejadas. Abierto 24h, gratis, baños limpios en la entrada.",
  ...
  tips: [
    { icon: "🌳", text: "<strong>Seoul Forest modo express:</strong> 50 min, no más. Solo el deer park y un paseo corto. Si nos relajamos aquí no llegamos a Hadongkwan antes del cierre" },
    ...
    { icon: "🚇", text: "<strong>Día casi todo en L2:</strong> Hongik → Ttukseom → Samseong → Euljiro 1-ga, todo directo. Solo al final un transbordo L1 (Jongno 3-ga ↔ Dongdaemun)" },
